...
function main() {
  ...
  // var loading_screen = document.createElement('loading_screen');
  // var context = loading_screen.getContext('2d');
  ...
  function add_path(points, pcolor, npoints) {
    ...
    const material = new THREE.LineBasicMaterial( { color : pcolor } );
...
function toggle_play_button() {
  // if (!start_animation) {
  //   get_gui_controller("Pause").__li.style.display = "none";
  //   get_gui_controller("Play").__li.style.display = "";
  // } else {
  //   get_gui_controller("Pause").__li.style.display = "";
  //   get_gui_controller("Play").__li.style.display = "none";
  // }
}
...
var grid_folder = cam.addFolder('Grids');
